...
const researchCards = [
  ...
  { id: "hyperphagia", title: "היפרפגיה — תדלוק לפני הטיסה", emoji: "⚖️", content: "לפני נדידה ציפורים עוברות היפרפגיה — אכילה מוגברת שמעלה את משקלן בשומן בצורה קיצונית. תהליך זה נמשך כשבועיים, ובסופו הגוף מוכן לטיסה הארוכה. הנתון המדויק מסתתר על המשקל בסצנה.", hiddenClue: "כמה אחוז שומן ממשקל הגוף ציפור מסוגלת לצבור? חפשו על המשקל בסצנה!" },
