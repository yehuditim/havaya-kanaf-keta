...
const sceneHotspots: SceneHotspot[] = [
  ...
  { id: "gps-device", x: "25%", y: "55%", emoji: "📡", label: "משדר GPS", clue: "משדר GPS זעיר — פחות מ-5 גרם! מוצמד לגב הציפור ושולח נתוני מיקום בזמן אמת. טכנולוגיה מרשימה — אך חוקרים עקבו אחרי ציפורים הרבה לפני עידן הלוויינים.", detail: "בכרטיסי המחקר חפשו את ציר הזמן של שיטות המעקב — מתי הומצאה השיטה הוותיקה ביותר?" },
...
const researchCards = [
  { id: "tech", title: "טיבוע, GPS ומכ״ם", emoji: "📡", content: "שלוש שיטות מעקב מרכזיות: טיבוע — טבעת אלומיניום עם מספר ייחודי, שיטה שהדנמרקי Mortensen פיתח שנה אחת לפני שהמאה ה-20 החלה. GPS — משדרי מיניאטורה שהחלו לשמש בשנות ה-2000. מכ״ם — מעקב אחרי להקות שלמות מרחוק, מאז שנות ה-1940.", hiddenClue: "שלוש שיטות, שלוש תקופות — מתי בדיוק הומצא הטיבוע? חשבו: שנה לפני מה?" },
            ...
            <motion.div key="briefing" variants={phaseVariants} initial="initial" animate="animate" exit="exit" transition={phaseTransition} className="space-y-4">
              <div className="glass-card-immersive rounded-2xl p-5 station-glow-4">
                ...
                <NarrationPlayer
                  ...
                  audioSrc="/narration/station4-lab.wav"
                  className="mb-3"
                />
