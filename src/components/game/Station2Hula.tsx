...
const sceneHotspots: SceneHotspot[] = [
  ...
  { id: "screen", x: "72%", y: "18%", emoji: "🖥️", label: "מסך נתונים", clue: "לוח נתוני תצפית: עד 40,000 עגורים אפורים חונים באגמון בכל חורף!", detail: "אגמון החולה — תחנת תדלוק בינלאומית קריטית לציפורים נודדות" },
  ...
  { id: "feather", x: "30%", y: "78%", emoji: "🪶", label: "נוצה על השולחן", clue: "נוצה גדולה שנמצאה ליד הביצה. לפי מבנה הנוצה וגודלה, החוקרים מזהים את הנודד הגדול שהשאיר אותה — ידוע בריקוד חיזור מרהיב. שמו שמור בצופן.", detail: "בשלב הפענוח תקבלו את שמו המוצפן — חשבו מי הוא הנודד הגדול ידוע הריקוד של אגמון החולה" },
];

const researchCards = [
  { id: "hula", title: "אגמון החולה", emoji: "🌿", content: "עמק החולה בצפון הוא ״האב של האקולוגיה הצפונית״. ביצות, שדות חקלאיים ובריכות דגים מושכים חצי מיליארד ציפורים בשנה! רבבות עגורים אפורים בוחרים בחולה כאתר חניה לחורף — המספר המדויק מופיע בנתוני התצפית שגיליתם בסצנה.", hiddenClue: "רמז: המספר המדויק מופיע במסך הנתונים שמצאתם בתחנת התצפית!" },
